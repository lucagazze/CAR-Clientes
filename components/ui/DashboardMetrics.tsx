...
const MetricDetailChartComponent = ({ label, data = [], prevData = [], color, emptyMessage }: any) => {
  ...
  if (!hasData) {
    return (
      <div className="bg-white dark:bg-zinc-900 border border-black/[0.06] dark:border-white/[0.06] rounded-[20px] p-4 sm:p-8 shadow-sm mt-4 flex flex-col items-center justify-center gap-3 h-[160px] print:hidden">
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 border border-black/[0.06] dark:border-white/[0.06] rounded-[20px] p-4 sm:p-8 shadow-sm mt-4 print:hidden">
