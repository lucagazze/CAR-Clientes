    ...
    <div className="space-y-6 w-full pt-6 px-4 md:px-6 lg:px-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full">
          ...
          {(['all', 'instagram', 'facebook', 'ads'] as const).map(p => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-[9.5px] sm:text-[10.5px] font-black transition-all border flex items-center gap-1.5 whitespace-nowrap flex-shrink-0 ${
                  isActive
              ...
              >
                <span>{label}</span>
                {count > 0 && (
                  <span className={`inline-flex items-center justify-center min-w-[12px] h-[12px] sm:min-w-[15px] sm:h-[15px] px-0.5 rounded-full text-[8.5px] sm:text-[9.5px] font-black leading-none ${badgeColor}`}>
                    {count}
                  </span>
                )}
              </button>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-xl text-[9.5px] sm:text-[10.5px] font-black border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-zinc-500 dark:text-zinc-400 hover:border-zinc-400 dark:hover:border-zinc-500 hover:text-zinc-800 dark:hover:text-zinc-200 transition-all"
        >
                ...
                {!loadingComments && comments.length > 0 && (
                  <div className="flex items-center gap-1 px-5 pt-4 pb-3 border-b border-zinc-100 dark:border-zinc-800 flex-shrink-0 bg-zinc-50/50 dark:bg-zinc-900/40">
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-[9.5px] sm:text-[10.5px] font-black transition-all ${
                    ...
                    >
                      Sin responder
                       <span className={`text-[8.5px] sm:text-[9.5px] min-w-[14px] h-[14px] sm:min-w-[16px] sm:h-[16px] px-0.5 rounded-full font-black flex items-center justify-center ${
                        commentFilter === 'pending'
