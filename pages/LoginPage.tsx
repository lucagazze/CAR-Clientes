          ...
          <div className={`rounded-3xl p-6 ${
            ...
            <form onSubmit={handleLogin} className="space-y-3">
              ...
              <div className="relative flex py-1 items-center">
                ...
                <span className="flex-shrink mx-3 text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">o</span>
                <div className="flex-grow border-t border-zinc-200/60 dark:border-white/[0.06]"></div>
              </div>
              ...
              <button
                ...
                className={`w-full h-12 flex items-center justify-center gap-2.5 rounded-2xl text-[14px] font-bold transition-all duration-200 disabled:opacity-50 disabled:pointer-events-none ${
                  darkMode
                    ? 'bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.07] text-white'
                    : 'bg-white border border-zinc-200 hover:bg-zinc-50 text-zinc-700 shadow-sm shadow-zinc-200/50'
                } hover:scale-[1.01] active:scale-[0.99]`}
              >
