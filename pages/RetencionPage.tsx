...
export default function RetencionPage() {
  ...
  const handleExportPDF = () => {
    ...
    document.title = `${businessName} - Email Marketing - Retencion - ${dateStr}`;
  ...
  return (
    ...
    <div className="w-full space-y-8 pt-4 md:pt-6">
      ...
      <div className="hidden print:block mb-6 pb-4 border-b-2 border-zinc-200">
        ...
        <p className="text-[13px] text-zinc-500 font-medium">Email Marketing — Análisis y Retención (Klaviyo)</p>
