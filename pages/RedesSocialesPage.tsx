        ...
        <div className="flex items-center gap-2 flex-wrap justify-start md:justify-end">
          ...
          <div className="flex items-center gap-1.5 bg-zinc-100/80 dark:bg-zinc-800/60 p-1 rounded-2xl border border-zinc-200/20 dark:border-zinc-700/60">
            <button
              ...
              className={`flex items-center gap-1 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-[9.5px] sm:text-[10.5px] font-black transition-all ${
                activeTab === 'instagram'
                      ...
                      {[
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-center gap-1.5 px-3 py-2 sm:px-3.5 sm:py-2 rounded-lg text-[9.5px] sm:text-[10.5px] font-black transition-all whitespace-nowrap ${
                              mediaFilter === f.id
            ...
            <div className="px-5 py-3 border-b border-zinc-100 dark:border-zinc-800 flex gap-2 flex-shrink-0">
              {(['all', 'instagram', 'facebook'] as const).map(f => (
                <button
                  ...
                  className={`px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-xl text-[9.5px] sm:text-[10px] font-black transition-all ${
