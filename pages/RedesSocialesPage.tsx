    ...
    <div className="space-y-5 md:space-y-8 w-full pt-3 md:pt-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200/60 dark:border-zinc-800/60 pb-5">
        ...
        <div className="flex items-center gap-2 flex-wrap justify-start md:justify-end">
          ...
          <div className="flex items-center gap-1 bg-zinc-100/80 dark:bg-zinc-800/60 p-0.5 rounded-xl border border-zinc-200/20 dark:border-zinc-700/60">
            <button
              onClick={() => setActiveTab('instagram')}
              className={`flex items-center gap-1 px-1.5 py-0.5 sm:px-2.5 sm:py-1 rounded-lg text-[9.5px] sm:text-[11px] font-black transition-all ${
                activeTab === 'instagram'
                      ...
                      {[
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-center gap-1 px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-md text-[8.5px] sm:text-[10px] font-black transition-all whitespace-nowrap ${
                              mediaFilter === f.id
