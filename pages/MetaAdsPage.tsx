...
export default function MetaAdsPage() {
  ...
  const fetchAds = (since?: string, until?: string) => {
    ...
    Promise.all([
      ...
      // Campañas/conjuntos eliminados no vienen en /campaigns ni /adsets: usar el nombre de insights.
  ...
  const storePlatform = normalizeEcommercePlatform(prof?.ecommerce_platform)
    || (prof?.shopify_domain && prof?.shopify_access_token ? 'shopify'
      : prof?.tiendanube_store_id && prof?.tiendanube_access_token ? 'tiendanube'
      : prof?.wordpress_url && prof?.woo_consumer_key ? 'wordpress' : null);
