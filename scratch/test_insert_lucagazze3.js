...
async function run() {
  const payload = {
    ...
    user_id: 'fda70225-ca3c-4fad-ad70-218c426050c9', // lucagazze3@gmail.com
    email: 'lucagazze3@gmail.com'
  };

  console.log("Attempting to insert lucagazze3 into car_business_accounts:", payload);
