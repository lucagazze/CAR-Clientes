...
export const UnreadProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Sincroniza el set de comentarios ignorados desde Supabase al cache local cuando
  // cambia el cliente, para que el conteo del badge use el dato autoritativo aunque
  // nunca se haya abierto la pagina de Comentarios en este dispositivo/navegador.
  useEffect(() => {
